<?php
add_action('acf/init', 'block_feature_tab_group');
function block_feature_tab_group() {
    if( function_exists('acf_register_block') ) {
        ...
        acf_register_block(array(
            'name'              => 'feature-tab-group',
            'title'             => __('Feature Tab Group'),
            'description'       => __('Feature Tab Group'),
            'render_template'   => 'block-parts/block-feature-tab-group.php',
            'category'          => 'theme',
            'icon'              => $icon,
            'keywords'          => array( 'features', 'tabs' ),
            'supports' => array(
